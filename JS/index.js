...
function todayData(){
    ...
    document.getElementById('day').innerHTML = date.toLocaleDateString('en',{weekday:'long'})
    document.getElementById('Month').innerHTML = date.toLocaleDateString('en',{month:'short'})
